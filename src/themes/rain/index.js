export const rainTheme = {
  ...
  description: "Quiet moments, louder stories.",
  ...
  colors: {
    ...
    textOnBackgroundSecondary: "#edf3f7",
    textOnBackgroundMuted: "#cbd6df",
  ...
  copy: {
    welcome: "Quiet moments, louder stories.",

    emptyStates: {
      books: "The shelves are waiting for the next rainy afternoon.",

      quotes: "Every unforgettable sentence begins with a single page.",

      reflections: "Some thoughts arrive as softly as rain.",

      discussions: "No conversations have disturbed the silence yet.",

      doodles: "The page is waiting for the first brushstroke.",
    },
