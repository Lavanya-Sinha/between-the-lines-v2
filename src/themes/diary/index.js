export const diaryTheme = {
    ...
    description:
        "Every memory deserves a page of its own.",
   ...
   typography: {
    ...
    copy: {
        ...
        emptyBooks:
            "Your bookshelf is waiting patiently.",

        emptyQuotes:
            "The words that move you will find their place here.",

        emptyReflections:
            "Every reflection begins with a single thought.",

        emptyDiscussions:
            "No conversations have been written yet.",
    },
