export const forestTheme = {
  ...
  description: "Every page is another trail waiting to be explored.",
  ...
  colors: {
    ...
    textOnBackgroundSecondary: "#edf3eb",
    textOnBackgroundMuted: "#cbd8c7",
  ...
  copy: {
    welcome: "Every page is another trail waiting to be explored.",

    emptyStates: {
      books: "Your shelves are waiting for another journey.",

      quotes: "The forest is quiet. Collect the words that speak to you.",

      reflections: "Some thoughts need time to take root.",

      discussions: "No conversations have echoed through the archive yet.",

      doodles: "The next sketch begins with a single line.",
    },
