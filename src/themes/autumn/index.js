export const autumnTheme = {
  ...
  colors: {
    ...
    textOnBackgroundSecondary: "#f5eee6",
    textOnBackgroundMuted: "#dfd2c5",
  ...
  copy: {
    welcome: "A warm place where every story feels like home.",

    emptyStates: {
      books: "Your bookshelf is waiting for its first story.",

      quotes: "Every memorable line has a home here.",

      reflections:
        "Some thoughts need a little time before they find their words.",

      discussions: "Every conversation begins with a single thought.",

      doodles: "An empty page is an invitation to create.",
    },
